...
interface Props extends WorkflowRunOptions {
  onChange: (value: WorkflowRunOptions) => void;
}

const QueryEditorWorkflowRun = (props: Props) => {
...
export default QueryEditorWorkflowRun;
